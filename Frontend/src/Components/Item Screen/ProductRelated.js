...
class ProductRelated extends Component {
    ...
    getProducts=async()=>{
        ...
        if(id){
            ...
            await axios.get(`${api.productApi}/view/category/${id}`)
            .then(({data})=>{
    ...
    render() {
        ...
        return (
            <div className="product-related-container">
                {loading ?
                    <SkeletonTheme color="rgb(225, 225, 225)" highlightColor="rgb(215, 215, 215)">
                ...
                <Slider
                    ...
                    >
                        {products.map(item=>{
                            ...
                            return (
                                <div key={id} >
                                    <div onClick={()=>handleClick(id)} className="item-container">
